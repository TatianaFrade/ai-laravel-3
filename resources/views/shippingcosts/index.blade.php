                                            ...
                                            <div class="flex items-center justify-center space-x-2">
                                                ...
                                                @if(!$cost->trashed())
                                                    ...
                                                    <form method="POST" action="{{ route('shippingcosts.destroy', $cost) }}"
                                                        class="inline-flex" onsubmit="return confirm('Are you sure you want to delete this shipping cost?')">
                                                        @csrf
                                                        @method('DELETE')
                                                ...
                                                @else
                                                    <form method="POST" action="{{ route('shippingcosts.restore', ['shippingcost' => $cost->id]) }}"
                                                        class="inline-flex">
                                                        @csrf
