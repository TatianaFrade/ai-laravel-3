<x-layouts.main-content title="Statistics" heading="General Statistics" subheading="Overview of grocery store data">
    ...
    <div class="flex justify-end gap-4 mb-6">
        <a href="{{ route('statistics.basic') }}" class="px-4 py-2 bg-blue-600 text-white rounded hover:bg-blue-700">Basic</a>
        <a href="{{ route('statistics.advanced') }}" class="px-4 py-2 bg-gray-200 hover:bg-gray-300 rounded dark:bg-gray-700 dark:hover:bg-gray-600 dark:text-white">Advanced</a>
    </div>

    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        <!-- Users -->
        <div class="bg-white dark:bg-gray-900 shadow rounded-lg p-4">
            <h3 class="text-lg font-semibold mb-2 dark:text-white">👥 Users</h3>
        ...
        <!-- Total Sales -->
        <div class="bg-white dark:bg-gray-900 shadow rounded-lg p-4">
            <h3 class="text-lg font-semibold mb-2 dark:text-white">💰 Total Sales</h3>
        ...
        <!-- Orders -->
        <div class="bg-white dark:bg-gray-900 shadow rounded-lg p-4 md:col-span-2 lg:col-span-3">
            <h3 class="text-lg font-semibold mb-2 dark:text-white">📦 Orders by Status</h3>
            <table class="w-full text-sm text-left text-gray-700 dark:text-gray-300">
