      ...
      <div class="my-4 p-6 w-full">
        ...
        <div class="my-4 font-base text-sm text-gray-700 dark:text-gray-300">
          <table class="table w-full border-collapse">
            <thead>
              <tr class="border-b-2 border-b-gray-400 dark:border-b-gray-500 bg-gray-100 dark:bg-gray-800">                <th class="px-3 py-2 text-left">Id</th>
            ...
            <tbody>              @foreach ($allSupplyorders as $supplyorder)
              <tr class="border-b border-b-gray-400 dark:border-b-gray-500">
                <td class="px-3 py-2">{{ ($allSupplyorders->currentPage() - 1) * $allSupplyorders->perPage() + $loop->iteration }}</td>
                <td class="px-3 py-2">
                ...
                <td class="px-3 py-2">{{ $supplyorder->status }}</td>                <td class="px-3 py-2">{{ $supplyorder->quantity }}</td>
                <td class="px-3 py-2">{{ $supplyorder->created_at->format('Y-m-d H:i') }}</td>
